...
const getAllFromDB = (filters, options) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (searchTerm) {
        andConditions.push({
            OR: reviewRating_constants_1.reviewRatingSearchableFields.map(field => ({
                [field]: {
                    contains: searchTerm,
                    mode: 'insensitive',
                },
    ...
    if (Object.keys(filterData).length > 0) {
        andConditions.push({
            AND: Object.keys(filterData).map(key => {
                if (reviewRating_constants_1.reviewRatingRelationalFields.includes(key)) {
                    return {
                        [reviewRating_constants_1.reviewRatingRelationalFieldsMapper[key]]: {
                            id: filterData[key],
                        },
                    };
                }
