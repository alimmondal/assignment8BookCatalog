...
router.post('/', (0, auth_1.default)(user_1.ENUM_USER_ROLE.SUPER_ADMIN, user_1.ENUM_USER_ROLE.ADMIN), (0, validateRequest_1.default)(reviewRating_validations_1.ReviewValidation.create), reviewRating_controller_1.ReviewRatingController.insertIntoDB);
router.patch('/:id', (0, auth_1.default)(user_1.ENUM_USER_ROLE.SUPER_ADMIN, user_1.ENUM_USER_ROLE.ADMIN), (0, validateRequest_1.default)(reviewRating_validations_1.ReviewValidation.update), reviewRating_controller_1.ReviewRatingController.updateIntoDB);
